...
class WebSearchTool(Tool):
    """Search the web using DuckDuckGo via duckduckgo-search library (no authentication required)."""
    ...
    def __init__(self, api_key: str | None = None, max_results: int = 5):
        # api_key parameter kept for backward compatibility but not used with DuckDuckGo
